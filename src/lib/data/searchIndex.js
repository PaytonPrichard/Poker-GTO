...
export const sectionLabels = {
  ...
  position:    'Preflop › Position Strategy',
  postflop:    'Postflop › Flop / Turn / River',
  handreading: 'Postflop › Hand Reading',
  bluffing:    'Postflop › Bluffing & Reads',
  multiway:    'Postflop › Multiway Pots',
  equity:      'Theory › Hand Equity',
  ...
  stats:       'Tools › My Stats',
  walkthrough: 'Tools › Hand Walkthrough',
  daily:       'Tools › Daily Practice',
  cheatsheet:  'Tools › Cheat Sheet',
  'range-builder': 'Tools › Range Builder',
  quiz:        'Tools › Quiz Mode',
  glossary:    'Tools › Glossary',
  notes:       'Tools › Session Notes',
};
